...
function App() {
  ...
  const [progress, setProgress] = reactExports.useState(0.35);
  const [progressSecs, setProgressSecs] = reactExports.useState(84);
  const [volume, setVolume] = reactExports.useState(0.72);
  const [shuffle, setShuffle] = reactExports.useState(false);
  const [repeat, setRepeat] = reactExports.useState(false);
  const [atmos, setAtmos] = reactExports.useState(false);
  const [liked, setLiked] = reactExports.useState(false);
  const [trackInfoChanging, setTrackInfoChanging] = reactExports.useState(false);
  const [activeTab, setActiveTab] = reactExports.useState("Discover");
  const [playBeat, setPlayBeat] = reactExports.useState(false);
  const [progPulsing, setProgPulsing] = reactExports.useState(false);
  const [ripples, setRipples] = reactExports.useState([]);
  const eqContainerRef = reactExports.useRef(null);
  const albumContainerRef = reactExports.useRef(null);
  const stageRef = reactExports.useRef(null);
  const barRef = reactExports.useRef(null);
  const progressTrackRef = reactExports.useRef(null);
  const volTrackRef = reactExports.useRef(null);
  const eqRafRef = reactExports.useRef(0);
  const progressTimerRef = reactExports.useRef(null);
  const progressSecsRef = reactExports.useRef(84);
  const progressRef = reactExports.useRef(0.35);
  const rippleKeyRef = reactExports.useRef(0);
  ...
  reactExports.useEffect(() => {
    document.documentElement.style.setProperty("--glow", track2.glow);
  }, [track2.glow]);
  reactExports.useEffect(() => {
    ...
    const animate = () => {
      ...
      if (eqContainerRef.current) {
        ...
        for (const bar of eqContainerRef.current.querySelectorAll(
          ...
          bar.style.opacity = String(0.4 + h / 24 * 0.6);
          idx++;
        }
      }
  ...
  const switchTrack = reactExports.useCallback((idx) => {
  ...
  reactExports.useEffect(() => {
    ...
    const onLeave = () => {
      container.style.transform = "perspective(1200px) rotateX(0) rotateY(0) translateZ(0)";
  ...
  reactExports.useEffect(() => {
    ...
    const onMove = (e) => {
      ...
      bar.style.boxShadow = `0 -8px 40px rgba(0,0,0,0.3), 0 0 60px ${track2.glow.replace(/[\d.]+\)/, "0.12)")}`;
    };
    const onLeave = () => {
      bar.style.transform = "perspective(1200px) rotateX(0) rotateY(0) scale(1)";
      bar.style.transition = "transform 0.6s cubic-bezier(0.34,1.56,0.64,1), box-shadow 0.4s";
      bar.style.boxShadow = "";
    };
  ...
  reactExports.useEffect(() => {
    ...
    const setFromEvent = (clientX) => {
      ...
      const dur = parseDuration(tracks[currentTrack].duration);
      const secs = Math.round(pct2 * dur);
  ...
  const bgStyle = {
    background: `radial-gradient(ellipse 60% 50% at 50% 110%, ${track2.color2} 0%, #080b12 70%), radial-gradient(ellipse 100% 80% at 80% 0%, ${track2.color1}88 0%, transparent 60%)`
  };
  const pct = `${progress * 100}%`;
  const currentTimeStr = formatTime(progressSecs);
  const totalTimeStr = track2.duration;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bg-canvas", style: bgStyle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-noise" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-app", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sw-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-logo", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-logo-icon", children: "🎵" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-logo-text", children: [
            "Sound",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "wave" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "sw-nav-tabs", children: NAV_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-header-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-atmos-dot" }),
              "Dolby Atmos"
            ]
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-content", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "sw-sidebar", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-sidebar-section", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-sidebar-label", children: "Browse" }),
            browseItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `sw-sidebar-item${item.active ? " active" : ""}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-sidebar-icon", children: item.icon }),
                  " ",
                  item.label
                ]
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-sidebar-section", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-sidebar-label", children: "Your Music" }),
            libraryItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-sidebar-item", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-sidebar-icon", children: item.icon }),
              " ",
              item.label
            ] }, item.label))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-sidebar-section", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-sidebar-label", children: "Up Next" }),
            tracks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-num", children: i + 1 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-queue-bars", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-bar" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-bar" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-bar" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-queue-info", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-title", children: t.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-artist", children: t.artist })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-queue-dur", children: t.duration })
                ]
              },
              t.title
            ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "main",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-album-container", ref: albumContainerRef, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "sw-album-aura",
                    style: {
                      background: `radial-gradient(circle, ${track2.glow.replace(/[\d.]+\)/, "0.6)")} 0%, transparent 70%)`
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-album-ring" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-album-art", children: track2.art })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-eq-container", ref: eqContainerRef, children: Array.from({ length: 18 }).map((_, i) => (
                // biome-ignore lint/suspicious/noArrayIndexKey: static array
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-eq-bar" }, i)
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-track-title", children: track2.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-track-artist", children: [
                      track2.artist,
                      " · ",
                      track2.album
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-track-tags", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-track-tag sw-tag-quality", children: "LOSSLESS" }),
                      atmos && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-track-tag sw-tag-atmos", children: "ATMOS" })
                    ] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-progress-section", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-progress-times", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: currentTimeStr }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: totalTimeStr })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-progress-track", ref: progressTrackRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `sw-progress-fill${progPulsing ? " pulsing" : ""}`,
                    style: { width: pct },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-progress-thumb" })
                  }
                ) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-controls", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-play-btn-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-volume-section", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-vol-icon", children: "🔈" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-vol-track", ref: volTrackRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "sw-vol-fill",
                    style: { width: `${volume * 100}%` },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-vol-thumb" })
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-vol-icon", children: "🔊" })
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "sw-featured-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-featured-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-featured-title", children: "Featured Playlists" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-see-all", children: "See all →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-cards-grid", children: playlists.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "sw-card",
              style: { animationDelay: `${i * 0.06}s` },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-card-art", children: p.art }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-card-info", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-card-name", children: p.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-card-sub", children: p.sub })
                ] })
              ]
            },
            p.name
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-featured-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-featured-title", children: "Trending Now" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-see-all", children: "See all →" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-cards-grid", children: trending.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "sw-card",
              style: { animationDelay: `${i * 0.06}s` },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-card-art", children: t.art }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-card-info", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-card-name", children: t.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-card-sub", children: t.sub })
                ] })
              ]
            },
            t.name
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "sw-footer", children: [
            "© ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-atmos-aura", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-atmos-wave" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-atmos-wave" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-atmos-wave" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-bar-track", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-art", children: track2.art }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-bar-info", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-title", children: track2.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-artist", children: track2.artist })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-bar-controls", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-bar-progress", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-prog-track", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-prog-fill", style: { width: pct } }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-bar-times", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: currentTimeStr }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: totalTimeStr })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sw-bar-vol", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sw-bar-icon", children: "🔊" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sw-bar-vol-track", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
Service({
  "getDisplayName": Func([], [Text], ["query"]),
  "getLikedSongs": Func([], [Vec(Text)], ["query"]),
  "isSongLiked": Func([Text], [Bool], ["query"]),
  "setDisplayName": Func([Text], [], []),
  "toggleSongLike": Func([Text], [], []),
  "unlikeSong": Func([Text], [], [])
});
