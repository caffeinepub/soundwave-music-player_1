...
export class Backend implements backendInterface {
    ...
    async getLikedSongs(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async isSongLiked(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isSongLiked(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleSongLike(arg0: string): Promise<void> {
        if (this.processError) {
            try {
